...
public class PoliciesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mText.setText("DATED\n" +
                ...
                "4.\tAcceptable use restrictions\t3\n" +
                ...
                "\n" +
                " \n" +
                "THIS AGREEMENT is dated [7th/4/2017]\n" +
                ...
                "•\t[POTHOLE REPORTING APP version 1] mobile application software (App); and\n" +
                ...
                "Operating system requirements This App requires an Android device with a minimum of [517mb] of memory. Internet access and the [ANDROID ] operating system [MINIMUM KITKAT]. \n" +
                "Important notice:\n" +
                ...
                "2.2\tYou may:\n" +
                "(a)\tdownload or stream a copy of the App onto an Android device and to view, use and display the App on the Devices for your personal purposes only; and\n" +
                ...
                "7.3\tOur maximum aggregate liability under or in connection with this EULA (including your use of any Services) whether in contract, tort (including negligence) or otherwise, shall in all circumstances be limited to GBP30. This does not apply to the types of loss set out in condition 7.47.4.\n" +
                ...
                "9.1\tIf you wish to contact us in writing, or if any condition in this EULA requires you to give us notice in writing, you can send this to us by e-mail at [baswetima@gmail.com]. We will confirm receipt of this by contacting you in writing, normally by e-mail. \n" +
